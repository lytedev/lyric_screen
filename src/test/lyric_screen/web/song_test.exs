defmodule LyricScreen.SongParserTest do
  ...
  # iex> LyricScreen.Song.Parser.raw_data("The Title\\nmap$alt8: Verse 1, Verse 1, Verse 1\\n\\nVerse 1:\\nVerse Content\\nMore Verse Content\\n\\nBare\\n\\n(Verse 1)")
  # {:ok, [{:title, "The Title"}, {:named_verse, [{:verse_name, "Verse 1"}, "Verse Content", "More Verse Content"]}, {:bare_verse, ["Bare"]}, {:verse_ref, "Verse 1"}], "", %{}, {9, 60}, 69}
end
